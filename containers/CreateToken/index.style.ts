...
import BackgroundCreateToken from '@/assets/images/background-create-token.png';

const StyledCreateTokenContainer = styled(Box)`
  margin-top: 76px;
  background-image: url(${BackgroundCreateToken.src});
...
export { StyledCreateTokenContainer };
